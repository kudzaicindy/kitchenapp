...
const UtensilsModal = ({ isOpen, onClose, onSelectLocation }) => {
  const utensilsImages = [
    { 
      id: 1, 
      image: '/utensils1.jpg', 
      location: 'Upper Cabinet',
      description: 'Easy access for daily cooking utensils'
    },
    { 
      id: 2, 
      image: '/utensils2.jpg', 
      location: 'Lower Cabinet',
      description: 'Organized storage for larger utensils'
    },
    { 
      id: 3, 
      image: '/utensils3.jpg', 
      location: 'Drawer',
      description: 'Perfect drawer organization for utensils'
    },
    { 
      id: 4, 
      image: '/knife set.jpg', 
      location: 'Drawer',
      description: 'Safe storage for sharp knives'
    },
    { 
      id: 5, 
      image: '/wooden spoons.jpg', 
      location: 'Upper Cabinet',
      description: 'Easy access for cooking spoons'
    },
    { 
      id: 6, 
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gradient-to-r from-primary-600 to-primary-700">
          <div>
            <h2 className="text-2xl font-bold text-white mb-1">
              Select Utensils Location
            </h2>
            <p className="text-primary-100 text-sm">
              Choose the perfect spot for your kitchen utensils
            </p>
          </div>
          <button 
            onClick={onClose}
            ...
            {utensilsImages.map((item) => (
              ...
              >
                ...
                <div className="aspect-w-16 aspect-h-12">
                  <img 
                    src={item.image}
                    alt={`Utensils storage option ${item.id}`}
