...
const IngredientsModal = ({ isOpen, onClose, onSelectLocation }) => {
  const ingredientsImages = [
    { 
      id: 1, 
      image: '/sugar.jpg', 
      location: 'Upper Cabinet',
      description: 'Easy access for daily cooking needs'
    },
    { 
      id: 2, 
      image: '/spices.jpg', 
      location: 'Spice Rack',
      description: 'Organized storage for spices and seasonings'
    },
    { 
      id: 3, 
      image: '/salt.jpg', 
      location: 'Lower Cabinet',
      description: 'Convenient storage for cooking essentials'
    }
  ];
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gradient-to-r from-primary-600 to-primary-700">
          <div>
            ...
            <p className="text-primary-100 text-sm">
              Choose the perfect spot for your ingredients
            </p>
          </div>
          <button 
            onClick={onClose}
            ...
            {ingredientsImages.map((item) => (
              ...
              >
                ...
                <div className="aspect-w-16 aspect-h-12">
                  <img 
                    src={item.image}
                    alt={`Ingredients storage option ${item.id}`}
